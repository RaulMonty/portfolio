  ...
  const DemoButton = ({ proyecto, compact = false }: { proyecto: any; compact?: boolean }) => {
    ...
    return (
      <a
        ...
        rel="noreferrer"
        className={[
          "inline-flex items-center justify-center gap-2 rounded-2xl font-semibold text-white bg-gradient-to-r from-cyan-300 to-blue-400 shadow-[0_15px_40px_-12px_rgba(0,250,250,.45)] transition hover:brightness-110",
    ...
    >
      <div className="max-w-3xl">
        ...
        <p className="mt-6 max-w-2xl text-white/55 text-base sm:text-lg leading-8">
          Proyectos centrados en el diseño y desarrollo de aplicaciones web atractivas y reales, utilizando técnicas de frontend.
        </p>
      </div>
